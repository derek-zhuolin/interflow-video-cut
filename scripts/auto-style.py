...
# 风格分桶（与现存 10 个风格一致；按明暗×冷暖给主选 + 备选）
# dark 组: nebula-glass(冷·粒子) / glass(冷·玻璃拟态) / spatial(暖) / geom(撞色) / terminal(绿·技术)
# light 组: swiss(纯白·最干净) / minimal(黑白) / pastel-aura(冷柔浅色) / editorial-print(暖纸·montage)
RECO = {
    ("dark",  "cool"):    ["nebula-glass", "glass", "geom"],
    ("dark",  "warm"):    ["spatial", "nebula-glass", "glass"],
    ("dark",  "neutral"): ["nebula-glass", "glass", "spatial"],
...
CN_NAME = {
    "nebula-glass": "暗夜星河", "glass": "玻璃拟态", "spatial": "暖光太空",
